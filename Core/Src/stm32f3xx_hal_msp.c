...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA3     ------> ADC1_IN4
    */
    HAL_GPIO_DeInit(GPIOA, STM_INTERN_SENSE_Pin|STM_12V_SENSE_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA6     ------> ADC2_IN3
    */
    HAL_GPIO_DeInit(GPIOA, STM_DRIVE_1_SENSE_Pin|STM_5V_SENSE_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PB1     ------> ADC3_IN1
    */
    HAL_GPIO_DeInit(STM_DRIVE_2_SENSE_GPIO_Port, STM_DRIVE_2_SENSE_Pin);
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    PB14     ------> ADC4_IN4
    */
    HAL_GPIO_DeInit(GPIOB, STM_ARM_SENSE_Pin|STM_48V_SENSE_Pin);
